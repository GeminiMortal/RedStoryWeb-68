...
// @ts-ignore;
import { BookOpen, Clock, MapPin, User, Eye, Plus, Search, Menu } from 'lucide-react';
...
export default function HomePage(props) {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="md:hidden bg-gray-800/90 backdrop-blur-sm border-b border-gray-700 px-4 py-3 flex items-center justify-between">
        ...
        <button onClick={() => setShowMobileMenu(!showMobileMenu)} className="p-2 text-gray-300 hover:text-white">
      ...
      <div className="flex-1 transition-all duration-300 ease-in-out md:ml-0">
        ...
        <header className="hidden md:block bg-gray-800/90 backdrop-blur-sm border-b border-gray-700">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">红色故事</h1>
        ...
        <main className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-8 pb-24 md:pb-8">
          {loading ? <LoadingSkeleton type="card" count={6} /> : filteredStories.length === 0 ? <div className="text-center py-12 animate-fade-in">
              ...
              <h3 className="text-xl font-medium text-gray-400 mb-2">暂无故事</h3>
            ...
            params: {}
              ...
              {filteredStories.map((story, index) => <AnimatedCard key={story._id} delay={index}>
                  <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700 hover:border-red-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-red-500/10 hover:-translate-y-1">
