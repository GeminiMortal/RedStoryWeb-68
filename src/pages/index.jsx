...
// @ts-ignore;
import { BookOpen, Clock, MapPin, User, Eye, Plus, Search, TrendingUp, Heart, Filter, Loader2, RefreshCw } from 'lucide-react';
// @ts-ignore;
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <main className={cn("transition-all duration-300 ease-in-out", getMainMargin())}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
          {loading ? <LoadingSkeleton type="card" count={6} /> : error ? <ErrorState /> : filteredStories.length === 0 ? <div className="text-center py-16 animate-fade-in">
              ...
              animationDelay: `${index * 100}ms`
                    ...
                    <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-red-500/10 hover:border-red-500/50 transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] cursor-pointer" onClick={() => handleStoryClick(story._id)}>
